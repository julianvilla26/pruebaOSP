...
public class VerificarLaSimulacionDeInversionVirtualXml implements Question<Boolean> {

    private static final Logger LOGGER = LogManager.getLogger(VerificarLaSimulacionDeInversionVirtualXml.class.getName());
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        Serenity.recordReportData().withTitle("Response Simulacion de Inversion virtual").andContents(Serenity.sessionVariableCalled(response));
        return result;
    }
