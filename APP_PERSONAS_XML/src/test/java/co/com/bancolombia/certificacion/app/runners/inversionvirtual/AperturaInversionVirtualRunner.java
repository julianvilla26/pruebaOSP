...
public class AperturaInversionVirtualRunner {

    private AperturaInversionVirtualRunner(){}

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/inversionvirtual/Trn0326AperturaInversionVirtual.feature");
    }
}
