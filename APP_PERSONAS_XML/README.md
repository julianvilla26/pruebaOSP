# Automatización de Pruebas para APP Personas
### Descripción y contexto
---

Paga tus facturas y productos Bancolombia, transfiere, consulta y conoce tus movimientos desde tu dispositivo móvil con App Personas.

Descárgala de manera fácil y gratuita en tu celular y estaremos al alcance de tu mano en todo momento.

##**Con App Personas estamos siempre conectados**
¡Sácale el mayor provecho a tu smartphone y tableta! A través de App Personas tienes a tu mano en todo momento, la información de tus productos y las noticias económicas en una sola aplicación.
...
EnterAndHide: interacción que le permite ingresar un texto y ocultarlo debajo de otro, el valor predeterminado de "cualquier texto", pero se puede cambiar utilizando el método as. Ver ejemplo de implemetacion
