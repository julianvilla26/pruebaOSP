...
@CucumberOptions(
        features = {"src/test/resources/features/administrarfacturas/consulta_detalle_factura_programada.feature"},
        glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
        snippets = SnippetType.CAMELCASE
)
public class ConsultarDetalleFacturasProgramada {
    private ConsultarDetalleFacturasProgramada() {
        throw new IllegalStateException(CLASE_RUNNER);
    }

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/administrarfacturas/consulta_detalle_factura_programada.feature");
    }
}
