...
@CucumberOptions(
        features = {"src/test/resources/features/administrarfacturas/historico_pago.feature"},
        glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
        snippets = SnippetType.CAMELCASE
)
public class HistoricoPago {
    private HistoricoPago() {
        throw new IllegalStateException(CLASE_RUNNER);
    }

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/administrarfacturas/historico_pago.feature");
    }
}
