...
@CucumberOptions(
        features = {"src/test/resources/features/administrarfacturas/editar_descripcion_factura_inscrita.feature"},
        glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
        snippets = SnippetType.CAMELCASE
)
public class ModificarFacturaInscrita {
    private ModificarFacturaInscrita() {
        throw new IllegalStateException(CLASE_RUNNER);
    }

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/administrarfacturas/editar_descripcion_factura_inscrita.feature");
    }
}
