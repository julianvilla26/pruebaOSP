...
@CucumberOptions(
        features = {"src/test/resources/features/transferencia/transferencia_otros_bancos.feature"},
        glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
        snippets = SnippetType.CAMELCASE)
public class TransferenciaOtrosBancosRunner {

    public TransferenciaOtrosBancosRunner() {
        throw new IllegalStateException(CLASE_RUNNER);
    }

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/transferencia/transferencia_otros_bancos.feature");
    }
}
