...
@CucumberOptions(
        features = {"src/test/resources/features/administrarfacturas/pagar_factura_redeban.feature"},
        glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
        snippets = SnippetType.CAMELCASE
)
public class PagarFacturaRedeban {
    private PagarFacturaRedeban() {
        throw new IllegalStateException(CLASE_RUNNER);
    }

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/administrarfacturas/pagar_factura_redeban.feature");
    }
}
