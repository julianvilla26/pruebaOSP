...
@CucumberOptions(
        features = {"src/test/resources/features/administrarfacturas/consultar_facturas_programadas.feature"},
        glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
        snippets = SnippetType.CAMELCASE
)
public class ConsultarFacturasProgramadas {
    private ConsultarFacturasProgramadas() {
        throw new IllegalStateException(CLASE_RUNNER);
    }

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/administrarfacturas/consultar_facturas_programadas.feature");
    }
}
