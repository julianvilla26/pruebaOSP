...
@CucumberOptions(
        features = {"src/test/resources/features/bloqueos/bloqueo_primera_clave.feature"},
        glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
        snippets = SnippetType.CAMELCASE
)
public class BloqueoPrimeraClaveRunner {
    private BloqueoPrimeraClaveRunner() {
        throw new IllegalStateException(CLASE_RUNNER);
    }

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/bloqueos/bloqueo_primera_clave.feature");
    }
}
