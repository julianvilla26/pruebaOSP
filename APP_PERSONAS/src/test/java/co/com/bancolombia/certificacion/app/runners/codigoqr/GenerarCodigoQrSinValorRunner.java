...
@CucumberOptions(
        features = {"src/test/resources/features/codigoqr/generar_codigo_qr_sin_valor.feature"},
        glue = {"co.com.bancolombia.certificacion.app.stepdefinitions"},
        snippets = SnippetType.CAMELCASE
)
public class GenerarCodigoQrSinValorRunner {
    public GenerarCodigoQrSinValorRunner() {
        throw new IllegalStateException(CLASE_RUNNER);
    }

    @BeforeSuite
    public static void test() throws InvalidFormatException, IOException {
        DataToFeature.overrideFeatureFiles("./src/test/resources/features/codigoqr/generar_codigo_qr_sin_valor.feature");
    }
}
